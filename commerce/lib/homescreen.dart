            ...
            Column(
              ...
              children: [
                ...
                Text('Home',
                    style: TextStyle(
                        color:
                            _currentIndex == 0 ? Colors.orange : Colors.grey)),
              ],
            ),
            ...
            Column(
              ...
              children: [
                ...
                Text('Category',
                    style: TextStyle(
                        color:
                            _currentIndex == 1 ? Colors.orange : Colors.grey)),
              ],
            ),
            ...
            Column(
              ...
              children: [
                ...
                Text('Message',
                    style: TextStyle(
                        color:
                            _currentIndex == 2 ? Colors.orange : Colors.grey)),
              ],
            ),
            // Cart Icon and Text
            Column(
              ...
              children: [
                ...
                Text('Cart',
                    style: TextStyle(
                        color:
                            _currentIndex == 3 ? Colors.orange : Colors.grey)),
              ],
            ),
            ...
            Column(
              ...
              children: [
                ...
                Text('Private',
                    style: TextStyle(
                        color:
                            _currentIndex == 4 ? Colors.orange : Colors.grey)),
              ],
            ),
          ],
        ),
